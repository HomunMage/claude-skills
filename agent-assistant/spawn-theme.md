...
GOAL: ${GOAL}
Load Skill(agentic-hive). Execute the full flow:
...
- Load `Skill(agentic-hive)` — it has the full hive workflow.
- Flow:
...
- The 900s bee timeout and ticket sizing rules from `Skill(agentic-hive)` apply.
